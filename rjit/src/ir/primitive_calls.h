...
class Recompile : public PrimitiveCall {
  public:
    ...
    static Recompile* create(Builder& b, ir::Value closure, ir::Value caller, ir::Value consts, ir::Value rho) {
        Sentinel s(b);
        return insertBefore(s, closure, caller, consts, rho);
    }

    static Recompile* insertBefore(llvm::Instruction* ins, ir::Value closure, ir::Value caller, ir::Value consts, ir::Value rho) {
        std::vector<llvm::Value*> args_;
        args_.push_back(closure);
        args_.push_back(caller);
    ...
    static llvm::FunctionType* intrinsicType() {
        return llvm::FunctionType::get(t::SEXP, {t::SEXP, t::nativeFunctionPtr_t, t::SEXP, t::SEXP},
                                       false);
    }
...
class CheckType : public PrimitiveCall {
  public:
    ...
    static llvm::FunctionType* intrinsicType() {
        return llvm::FunctionType::get(t::Void, {t::SEXP, t::Int},
                                       false);
    }
