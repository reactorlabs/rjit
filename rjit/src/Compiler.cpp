...
/********* The refactored compiler with builder starts below. Everything above ***********
  *                         should be in the builder.cpp.
  */
...
Value* Compiler::compileSymbol(SEXP value) {
    return ir::GenericGetVar::create(b, value, b.rho());
}
...
Value* Compiler::compileForLoop(SEXP ast) {
    ...
    Value* control1 = ir::IntegerAdd::create(b, control, constant(1));
